...
for i in range(10):
    Temizlik_Makinesi2.yavasla()
    Temizlik_Makinesi2.hizlan()
    Temizlik_Makinesi3.yavasla()
    Temizlik_Makinesi3.hizlan()
    Temizlik_Makinesi4.yavasla()
    Temizlik_Makinesi4.hizlan()
    Temizlik_Makinesi5.yavasla()
    Temizlik_Makinesi5.hizlan()
    Temizlik_Makinesi6.yavasla()
    Temizlik_Makinesi6.hizlan()
